...
proc.save_folder                 = 'J:\MEG_Research\SEF\hilbERD-fir-kaiserBeta';
...
%     cfg.detrend   = 'yes';
    ...
    save ([proc.save_folder,'\',b, '-hilbBaseBeta'], 'hilbBase', '-v7.3');
end
...
cfg.xlim = [-0.1 0.1];
cfg.ylim = 'maxmin';
ft_multiplotER(cfg, hilbERD{subj,1},hilbERD{subj,2},hilbERD{subj,3},hilbERD{subj,5},...
                hilbERD{subj,6});%,hilbERD{subj,6})
title(num2str(subj));
...
figure, boxplot(maxGammaValNorm([1  3 4 5],:))
title('norm')
...
[p, table, stats] = anova1(maxGammaValNorm([1 3 2 4 5 6],:));

figure,
[c, m, h, nms] = multcompare(stats,'alpha',0.5,'ctype','bonferroni');
