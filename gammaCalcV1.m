...
figure, boxplot(maxGammaChExtract([1  3:6],:))
...
[p, table, stats] = anova1(maxGammaChExtract([1 3 4 5 6],:));
...
figure,
subj = [1 2 3:7];
errorbar(1:6,mean(maxGammaChExtract(subj,:),1), std(maxGammaChExtract(subj,:)),...
